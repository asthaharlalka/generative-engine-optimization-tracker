...
# ── Run / Stop buttons — both always visible ──────────────────────────────────
...
with btn_col2:
    if st.button("⏹  Stop Scan", use_container_width=True):
        ...
        st.warning("Stop requested — will halt after current question finishes.")

if run:
    st.session_state.stop_scan = False  # reset on new run
